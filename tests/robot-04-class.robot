...
TC1702 - เจ้าหน้าที่ฝ่ายทะเบียนเพิ่มชั้นเรียนสำเร็จ(เพิ่มชื่อครูที่ปรึกษาดูแลชั้นเรียนในปีใหม่ซ้ำกับปีเก่า)
    [Documentation]    ทดสอบการเเพิ่มชื่อครูที่ปรึกษาดูแลชั้นเรียนในปีใหม่ซ้ำกับปีเก่า
    # เปิดเบราว์เซอร์ที่ URL ที่กำหนด โดยใช้ browser ที่ระบุ
    Open Browser    ${URL}    ${BROWSER}
    # ขยายหน้าต่างเบราว์เซอร์ให้เต็มจอ เพื่อป้องกันปัญหา element ไม่แสดง
    Maximize Browser Window
    ...
    Capture Page Screenshot With Name    TC1702_Add_Class_In_Different_Year_Success
    Close Browser

TC1703 - เจ้าหน้าที่ฝ่ายทะเบียนเพิ่มชั้นเรียนไม่สำเร็จ(กรอกตัวเลขชั้่นเรียนมากกว่าเลข 6)
    ...
    Capture Page Screenshot With Name    TC1703_Add_Class_Year_Error_More_Than_6
    Close Browser

TC1704 - เจ้าหน้าที่ฝ่ายทะเบียนเพิ่มชั้นเรียนไม่สำเร็จ(กรอกตัวเลขชั้่นเรียนมากกว่าเลข 7)
...
TC1705 - เจ้าหน้าที่ฝ่ายทะเบียนเพิ่มชั้นเรียนไม่สำเร็จ(ไม่กรอกตัวเลขชั้นเรียน)
...
TC1706 - เจ้าหน้าที่ฝ่ายทะเบียนเพิ่มชั้นเรียนไม่สำเร็จ(ไม่กรอกตัวเลขห้องเรียน)
    ...
    Capture Page Screenshot With Name    TC1706_Add_Class_Room_Error
    Close Browser

TC1707 - เจ้าหน้าที่ฝ่ายทะเบียนเพิ่มชั้นเรียนไม่สำเร็จ(ไม่เลือกครูที่ปรึกษา)
    ...
    Capture Page Screenshot With Name    TC1707_Add_Class_Teacher_Error
    Close Browser

TC1708 - เจ้าหน้าที่ฝ่ายทะเบียนแก้ไขชั้นเรียนสำเร็จ
    ...
    Capture Page Screenshot With Name    TC1708_Update_Class_Teacher_Success
    Close Browser

TC1709 - เจ้าหน้าที่ฝ่ายทะเบียนเพิ่มนักเรียนเข้าชั้นเรียนสำเร็จ
    ...
    Capture Page Screenshot With Name    TC1709_Add_Student_To_Class_Success
    Close Browser

TC1710 - เจ้าหน้าที่ฝ่ายทะเบียนเพิ่มนักเรียนเข้าชั้นเรียนไม่สำเร็จ(ไม่เลือกคำนำหน้า)
    [Documentation]    ทดสอบการเพิ่มนักเรียนเข้าชั้นเรียน
    # เปิดเบราว์เซอร์ที่ URL ที่กำหนด โดยใช้ browser ที่ระบุ
    Open Browser    ${URL}    ${BROWSER}
    # ขยายหน้าต่างเบราว์เซอร์ให้เต็มจอ เพื่อป้องกันปัญหา element ไม่แสดง
...
TC1710 - เจ้าหน้าที่ฝ่ายทะเบียนลบชั้นเรียนสำเร็จ
    ...
    Capture Page Screenshot With Name    TC1710_Delete_Class_Teacher_Success
    Close Browser
